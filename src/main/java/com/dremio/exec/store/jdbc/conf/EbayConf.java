...
@SourceType(value = "EbayARP", label = "Ebay",uiConfig = "ebay-layout.json")
public class EbayConf extends AbstractArpConf<EbayConf> {
  private static final String ARP_FILENAME = "arp/implementation/ebay-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.ebay.EbayDriver";
